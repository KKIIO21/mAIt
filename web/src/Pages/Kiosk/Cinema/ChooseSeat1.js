...
import './ChooseSeat1.css';
import moviePoster from './img/bum.jpeg';
import ResultModal from '../ResultModal';

function ChooseSeat1() {
    ...
    return (
        <div className="Seat-Movie1-background">
