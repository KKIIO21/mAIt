...
import "./CinemaMovie3.css";
import bumImage from './img/jeo.jpeg';
...
function CinemaMovie3() {
    ...
    const movie = {
        ...
        times: [
            ...
            { time: "15:20 - 17:30", seats: "108/120석", theater: "4관" },
    ...
    return (
        <div className="cinemaMovie3-background">
                    ...
                    <div className="showtimes-container">
                        {movie.times.map((timeSlot, index) => (
                            <button 
                                ...
                                onClick={index === 2 ? handleTimeSelect : handleWrongSelection}
                            >
